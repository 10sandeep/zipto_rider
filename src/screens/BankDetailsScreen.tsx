...
export default function BankDetailsScreen({navigation}: any) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Error',
        e?.response?.data?.message ?? 'Failed to save bank account',
      );
    } finally {
      setSaving(false);
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity
          onPress={() =>
            screen === 'list' ? navigation.goBack() : setScreen('list')
          }
            ...
            <>
                ...
                <ScrollView
                  ...
                  {accounts.map(acc => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.chip,
                        selectedId === acc.id && styles.chipActive,
                      ]}
                      ...
                      <Text
                        style={[
                          styles.chipText,
                          selectedId === acc.id && styles.chipTextActive,
                        ]}>
                        {acc.bank_name}
                        {acc.is_primary ? ' ★' : ''}
                      </Text>
              ...
              {selectedAccount && (
                <View style={styles.detailCard}>
                  ...
                  <DetailRow
                    label="IFSC Code"
                    value={selectedAccount.ifsc_code}
                  />
              ...
              <View style={styles.infoBox}>
                ...
                <Text style={styles.infoText}>
                  Your earnings are transferred to the primary (★) account every
                  Monday.
                </Text>
              </View>
        ...
        <KeyboardAvoidingView
          ...
          <ScrollView
            ...
            <FormField
              ...
              onChangeText={v =>
                setField('account_number', v.replace(/\D/g, ''))
              }
            ...
            <FormField
              ...
              onChangeText={v =>
                setField('confirm_account_number', v.replace(/\D/g, ''))
              }
              keyboardType="numeric"
            />
            <FormField
            ...
            <View style={styles.typeRow}>
              {(['savings', 'current'] as AccountType[]).map(t => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.typeBtn,
                    form.account_type === t && styles.typeBtnActive,
                  ]}
                  ...
                  <Text
                    style={[
                      styles.typeBtnText,
                      form.account_type === t && styles.typeBtnTextActive,
                    ]}>
